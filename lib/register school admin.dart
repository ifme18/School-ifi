  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      routes: {
        ...
        '/register': (context) =>  _RegistrationForm(),
      },
    );
  }
}
...
class __SignInFormState extends State<_SignInForm> {
  ...
  Future<void> _loginAdmin(String email, String password) async {
    ...
    if (user != null) {
      ...
      if (customClaims != null && customClaims.containsKey('role') && customClaims['role'] == 'admin') {
  ...
  Future<void> _loginStudent(String email, String password) async {
    ...
    if (user != null) {
      ...
      final customClaims = idTokenResult.claims;
      if (customClaims != null && customClaims.containsKey('role') && customClaims['role'] == 'student') {
  ...
  Future<void> _loginTeacher(String email, String password) async {
    ...
    if (user != null) {
      ...
      final customClaims = idTokenResult.claims;
      if (customClaims != null && customClaims.containsKey('role') && customClaims['role'] == 'teacher') {
